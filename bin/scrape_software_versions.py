...
regexes = {
    'nf-fastqc': ['v_pipeline.txt', r"(\S+)"],
    'Nextflow': ['v_nextflow.txt', r"(\S+)"],
    'FastQC': ['v_fastqc.txt', r"FastQC v(\S+)"],
    'Fastq-mcf': ['v_fastqmcf.txt', r"Version: (\S+)"],
    'Hisat2': ['v_hisat2.txt', r"/opt/conda/envs/nf-fastqc-1.0dev/bin/hisat2-align-s version (\S+)"],
...
results = OrderedDict()
results['nf-fastqc'] = '<span style="color:#999999;\">N/A</span>'
...
section_name: 'nf-fastqc Software Versions'
